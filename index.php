...
<html lang="th" class="h-full">
 <head>
  ...
  <title>ระบบคัดกรองโรคมือ เท้า ปาก โดยใช้ปัญญาประดิษฐ์</title>
 ...
 <body class="h-full overflow-auto gradient-bg">
  <div class="min-h-full flex flex-col w-full"><!-- Header -->
   ...
   <main class="flex-1 px-4 pb-4">
    <div class="max-w-4xl mx-auto"><!-- Instructions -->
     <div class="card-gradient rounded-2xl p-4 mb-4 shadow-lg">
      <div class="flex items-center gap-2 mb-2"><span class="text-2xl emoji-float">📖</span>
       <h2 class="text-lg font-semibold text-purple-700">วิธีใช้งาน</h2>
      </div>
      <ol class="text-sm text-gray-600 space-y-1 pl-4">
       <li class="flex items-center gap-2"><span class="bg-pink-400 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs font-bold">1</span> <span>เลือกบริเวณที่ต้องการตรวจ (มือ / เท้า / ปาก)</span></li>
       <li class="flex items-center gap-2"><span class="bg-orange-400 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs font-bold">2</span> <span>กดปุ่ม "เปิดกล้อง" เพื่อเริ่มถ่ายภาพ</span></li>
       <li class="flex items-center gap-2"><span class="bg-green-400 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs font-bold">3</span> <span>วางส่วนที่ต้องการตรวจให้ตรงกับกล้อง แล้วกด "ตรวจโรค"</span></li>
       <li class="flex items-center gap-2"><span class="bg-blue-400 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs font-bold">4</span> <span>รอผลการวิเคราะห์ หากผิดปกติจะมีเสียงเตือนยาว ปกติจะเสียงสั้น</span></li>
      </ol>
     </div><!-- Tab Navigation -->
     <div class="flex justify-center gap-2 mb-4"><button onclick="switchTab('hand')" id="tab-hand" class="tab-btn active px-6 py-3 rounded-full font-semibold shadow-lg flex items-center gap-2 bg-white"> <span class="text-xl">🖐️</span> <span>ตรวจมือ</span> </button> <button onclick="switchTab('foot')" id="tab-foot" class="tab-btn px-6 py-3 rounded-full font-semibold shadow-lg flex items-center gap-2 bg-white"> <span class="text-xl">🦶</span> <span>ตรวจเท้า</span> </button> <button onclick="switchTab('mouth')" id="tab-mouth" class="tab-btn px-6 py-3 rounded-full font-semibold shadow-lg flex items-center gap-2 bg-white"> <span class="text-xl">👄</span> <span>ตรวจปาก</span> </button>
     </div><!-- Current Check Area Label -->
     <div class="text-center mb-4"><span id="current-area" class="inline-block bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 py-2 rounded-full text-lg font-semibold shadow-lg"> 🖐️ กำลังตรวจ: บริเวณมือ </span>
     </div><!-- Timer -->
     <div class="text-center mb-4">
      <div class="inline-flex items-center gap-2 bg-white/80 px-6 py-2 rounded-full shadow-md"><span class="text-xl">⏱️</span> <span class="text-gray-600 font-medium">เวลา:</span> <span id="timer" class="text-2xl font-bold text-purple-600">00:00</span> <span class="text-gray-500">วินาที</span>
      </div>
     </div><!-- Webcam Area -->
     <div class="flex justify-center mb-4">
      <div class="webcam-container bg-gray-900 w-[300px] h-[300px] md:w-[400px] md:h-[400px] lg:w-[600px] lg:h-[600px] flex items-center justify-center relative overflow-hidden rounded-2xl">
       <div id="webcam-container" class="w-full h-full flex items-center justify-center">
        <div class="text-center text-white"><span class="text-6xl mb-4 block emoji-float">📷</span>
         <p class="text-lg">กดปุ่ม "เปิดกล้อง" เพื่อเริ่มต้น</p>
        </div>
       </div>
     ...
     <div class="card-gradient rounded-2xl p-4 shadow-lg mb-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4"><!-- Hand Result -->
       ...
       <div class="bg-gradient-to-br from-blue-100 to-cyan-100 rounded-xl p-4 text-center shadow-md"><span class="text-4xl mb-2 block">🦶</span>
        <h4 class="font-semibold text-blue-700 mb-2">บริเวณเท้า</h4>
       ...
       <div class="bg-gradient-to-br from-pink-100 to-rose-100 rounded-xl p-4 text-center shadow-md"><span class="text-4xl mb-2 block">👄</span>
        <h4 class="font-semibold text-pink-700 mb-2">บริเวณปาก</h4>
      ...
      <div id="overall-result" class="bg-gradient-to-r from-purple-100 via-pink-100 to-orange-100 rounded-xl p-4 text-center hidden">
       <h4 class="font-bold text-lg text-purple-700 mb-2">📋 สรุปผลการตรวจทั้งหมด</h4>
       <div id="summary-text" class="text-gray-700"></div>
      </div>
     </div><!-- Statistics Section -->
     <div class="card-gradient rounded-2xl p-4 shadow-lg">
      <h3 class="text-xl font-bold text-center mb-4 text-purple-700 flex items-center justify-center gap-2"><span class="text-2xl">📈</span> สถิติการวิเคราะห์</h3>
      ...
      <div class="text-center mt-4"><button onclick="resetStats()" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded-full font-medium shadow-md transition-all"> 🔄 รีเซ็ตสถิติ </button>
      </div>
   ...
   <footer class="text-center py-4 px-4">
    ...
    <p class="text-xs text-gray-400 mt-1">พัฒนาด้วย ❤️ เพื่อสุขภาพที่ดีของเด็กไทย</p>
   </footer>
  </div>
  <script>
        // Configuration
        ...
        function switchTab(tab) {
            ...
            const areaLabels = {
                hand: '🖐️ กำลังตรวจ: บริเวณมือ',
                foot: '🦶 กำลังตรวจ: บริเวณเท้า',
                mouth: '👄 กำลังตรวจ: บริเวณปาก'
            };
        ...
        function showCameraError() {
            ...
            webcamContainer.innerHTML = `
                <div class="text-center text-white p-4">
                    ...
                    <p class="text-lg mb-2">ไม่สามารถเปิดกล้องได้</p>
                    <p class="text-sm text-gray-300">กรุณาอนุญาตการเข้าถึงกล้อง</p>
                </div>
            `;
        }
        ...
        function stopCamera() {
            ...
            webcamContainer.innerHTML = `
                <div class="text-center text-white">
                    <span class="text-6xl mb-4 block emoji-float">📷</span>
                    <p class="text-lg">กดปุ่ม "เปิดกล้อง" เพื่อเริ่มต้น</p>
                </div>
            `;
        ...
        async function checkDisease() {
            ...
            if (model) {
                ...
                isAbnormal = maxClass.toLowerCase().includes('abnormal') || 
                            maxClass.toLowerCase().includes('ผิดปกติ') ||
                ...
                resultText = isAbnormal ? `ผิดปกติ (${confidence}%)` : `ปกติ (${confidence}%)`;
            }
        ...
        function updateResultDisplay(area) {
            ...
            if (result.isAbnormal) {
                statusEl.textContent = '⚠️ ผิดปกติ';
        ...
        function updateOverallSummary() {
            ...
            if (abnormalAreas.length === 0) {
                summaryText.innerHTML = `
                    <div class="text-green-600 font-bold text-lg mb-2">✅ ผลการตรวจปกติ</div>
                    <p class="text-sm">ตรวจแล้ว ${checkedAreas.length} บริเวณ - ไม่พบความผิดปกติ</p>
                `;
            } else {
                const areaNames = {
                    hand: 'มือ',
                ...
                summaryText.innerHTML = `
                    <div class="text-red-600 font-bold text-lg mb-2">⚠️ พบความผิดปกติ</div>
                    <p class="text-sm">บริเวณที่พบ: <strong>${abnormalNames}</strong></p>
                    <p class="text-xs mt-2 text-gray-500">แนะนำให้พบแพทย์เพื่อตรวจเพิ่มเติม</p>
                `;
            }
        }
        ...
        function resetStats() {
            ...
            ['hand', 'foot', 'mouth'].forEach(area => {
                document.getElementById(`${area}-result`).textContent = 'ยังไม่ได้ตรวจ';
